...
function EmptyState() {
  return (
    <div className="flex-1 flex flex-col items-center justify-center gap-3 p-6">
      <div className="w-16 h-16 rounded-md bg-bg-elevated border border-[#2a2a2e]
      ...
      <p className="text-[13px] text-text-muted text-center leading-relaxed">
        Storyboard appears<br />after generating
      </p>
    </div>
  )
}

export default function RightPanel({ title, badge, children }: RightPanelProps) {
  return (
    <aside className="
